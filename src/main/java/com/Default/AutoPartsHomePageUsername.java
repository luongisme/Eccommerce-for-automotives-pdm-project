...
public class AutoPartsHomePageUsername extends JFrame {
    
    public AutoPartsHomePageUsername() {
        ...
        try {
            ...
            usernameField.setMaximumSize(new Dimension(120, 28));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            AutoPartsHomePageUsername frame = new AutoPartsHomePageUsername();
            frame.setVisible(true);
        });
    }
