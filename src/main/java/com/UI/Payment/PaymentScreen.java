...
public class PaymentScreen extends Screen {
    ...
    // Convenience constructor for simple navigation (defaults to cart mode for current user)
    public PaymentScreen(AppFrame appFrame) {
        this(
            appFrame,
            com.service.UserSession.getInstance().getCurrentUser().getUserID(),
            "TEMP_ORDER_ID", // TODO: replace with real order creation
            true
        );
    }
